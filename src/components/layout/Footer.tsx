...
export default function Footer() {
  return (
    <footer className="bg-tertiary text-black pt-14 pb-10 xl:pt-16 xl:pb-12">
      <div className="container-responsive">
          ...
          <nav className="flex flex-col gap-3 pr-12 xl:pr-16">
            {[
              ...
              <a
                key={link.label}
                href={link.href}
                className="text-[12.5px] tracking-wide text-black/80 hover:text-primary transition-colors"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="border-t border-b border-black/30 py-6">
          <div className="relative flex flex-col gap-6 lg:flex-row justify-between items-center">
            ...
            {/* Legal Links */}
            <div className="flex gap-6 text-[12px] tracking-wide text-black/70">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-black/30 text-black/80 hover:text-primary hover:border-primary transition-all duration-300"
                >
                  {item.svg}
                </a>
              ))}
