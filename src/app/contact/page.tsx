...
<div>
  ...
  <div className="flex justify-center gap-5 flex-wrap">
    {[
      {
        label: 'YouTube',
        href:'https://www.youtube.com/@jculttrader',
        svg: (
      ...
      {
        label: 'Facebook',
        href: 'https://www.facebook.com/people/Jcult-Trader/61588190192508/',
        svg: (
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      {
        label: 'Instagram',
        href:'https://www.instagram.com/jculttrader/',
        svg: (
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      {
        label: 'X',
        href: 'https://x.com/jculttrader?s=21',
        svg: (
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      {
        label: 'LinkedIn',
        href:'linkedin.com/company/jculttrader/',
        svg: (
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
